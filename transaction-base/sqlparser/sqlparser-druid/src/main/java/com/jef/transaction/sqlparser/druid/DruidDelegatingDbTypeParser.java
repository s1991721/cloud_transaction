...
public class DruidDelegatingDbTypeParser implements DbTypeParser {
    ...
    void setClassLoader(ClassLoader classLoader) {
        try {
            Class<?> druidDbTypeParserImplClass = classLoader.loadClass("com.jef.transaction.sqlparser.druid.DruidDbTypeParserImpl");
