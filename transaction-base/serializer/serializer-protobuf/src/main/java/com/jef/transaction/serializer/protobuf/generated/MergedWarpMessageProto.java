...
public  final class MergedWarpMessageProto extends
        ...
        switch (tag) {
          ...
          case 24: {
            if (!((mutable_bitField0_ & 0x00000004) == 0x00000004)) {
              msgIds_ = new java.util.ArrayList<Integer>();
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return MergedWarpMessage.internal_static_io_seata_protocol_protobuf_MergedWarpMessageProto_descriptor;
  }

  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return MergedWarpMessage.internal_static_io_seata_protocol_protobuf_MergedWarpMessageProto_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            MergedWarpMessageProto.class, MergedWarpMessageProto.Builder.class);
  }
  ...
  private java.util.List<Integer> msgIds_;
  /**
  ...
  public static final class Builder extends
    ...
    // Construct using MergedWarpMessageProto.newBuilder()
    private Builder() {
    ...
    private java.util.List<Integer> msgIds_ = java.util.Collections.emptyList();
    private void ensureMsgIdsIsMutable() {
      if (!((bitField0_ & 0x00000004) == 0x00000004)) {
        msgIds_ = new java.util.ArrayList<Integer>(msgIds_);
