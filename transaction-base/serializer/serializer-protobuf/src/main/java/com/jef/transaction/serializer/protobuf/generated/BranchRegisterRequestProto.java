...
public  final class BranchRegisterRequestProto extends
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return  BranchRegisterRequest.internal_static_io_seata_protocol_protobuf_BranchRegisterRequestProto_descriptor;
  }

  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return  BranchRegisterRequest.internal_static_io_seata_protocol_protobuf_BranchRegisterRequestProto_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
             BranchRegisterRequestProto.class,  BranchRegisterRequestProto.Builder.class);
  }
  ...
  private volatile Object lockKey_;
  /**
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof  BranchRegisterRequestProto)) {
      return super.equals(obj);
    }
     BranchRegisterRequestProto other = ( BranchRegisterRequestProto) obj;
  ...
  public static  BranchRegisterRequestProto parseFrom(
  ...
  public static  BranchRegisterRequestProto parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static  BranchRegisterRequestProto parseFrom(
  ...
  public static  BranchRegisterRequestProto parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static  BranchRegisterRequestProto parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static  BranchRegisterRequestProto parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder( BranchRegisterRequestProto prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using  BranchRegisterRequestProto.newBuilder()
    private Builder() {
    ...
    public  BranchRegisterRequestProto getDefaultInstanceForType() {
      return  BranchRegisterRequestProto.getDefaultInstance();
    }

    public  BranchRegisterRequestProto build() {
       BranchRegisterRequestProto result = buildPartial();
    ...
    public  BranchRegisterRequestProto buildPartial() {
       BranchRegisterRequestProto result = new  BranchRegisterRequestProto(this);
      if (abstractTransactionRequestBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof  BranchRegisterRequestProto) {
        return mergeFrom(( BranchRegisterRequestProto)other);
      } else {
    ...
    public Builder mergeFrom( BranchRegisterRequestProto other) {
      if (other ==  BranchRegisterRequestProto.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
       BranchRegisterRequestProto parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = ( BranchRegisterRequestProto) e.getUnfinishedMessage();
  ...
  private static final  BranchRegisterRequestProto DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new  BranchRegisterRequestProto();
  }

  public static  BranchRegisterRequestProto getDefaultInstance() {
