...
public  final class GlobalStatusResponseProto extends
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return GlobalStatusResponse.internal_static_io_seata_protocol_protobuf_GlobalStatusResponseProto_descriptor;
  }

  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return GlobalStatusResponse.internal_static_io_seata_protocol_protobuf_GlobalStatusResponseProto_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            GlobalStatusResponseProto.class, GlobalStatusResponseProto.Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof GlobalStatusResponseProto)) {
      return super.equals(obj);
    }
    GlobalStatusResponseProto other = (GlobalStatusResponseProto) obj;
  ...
  public static GlobalStatusResponseProto parseFrom(
  ...
  public static GlobalStatusResponseProto parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static GlobalStatusResponseProto parseFrom(
  ...
  public static GlobalStatusResponseProto parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static GlobalStatusResponseProto parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static GlobalStatusResponseProto parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(GlobalStatusResponseProto prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using GlobalStatusResponseProto.newBuilder()
    private Builder() {
    ...
    public GlobalStatusResponseProto getDefaultInstanceForType() {
      return GlobalStatusResponseProto.getDefaultInstance();
    }

    public GlobalStatusResponseProto build() {
      GlobalStatusResponseProto result = buildPartial();
    ...
    public GlobalStatusResponseProto buildPartial() {
      GlobalStatusResponseProto result = new GlobalStatusResponseProto(this);
      if (abstractGlobalEndResponseBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof GlobalStatusResponseProto) {
        return mergeFrom((GlobalStatusResponseProto)other);
      } else {
    ...
    public Builder mergeFrom(GlobalStatusResponseProto other) {
      if (other == GlobalStatusResponseProto.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      GlobalStatusResponseProto parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (GlobalStatusResponseProto) e.getUnfinishedMessage();
  ...
  private static final GlobalStatusResponseProto DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GlobalStatusResponseProto();
  }

  public static GlobalStatusResponseProto getDefaultInstance() {
