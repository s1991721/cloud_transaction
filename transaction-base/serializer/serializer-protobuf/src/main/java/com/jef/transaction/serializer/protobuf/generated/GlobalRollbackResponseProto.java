...
public  final class GlobalRollbackResponseProto extends
  ...
  protected FieldAccessorTable
    ...
    return GlobalRollbackResponse.internal_static_io_seata_protocol_protobuf_GlobalRollbackResponseProto_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            GlobalRollbackResponseProto.class, GlobalRollbackResponseProto.Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    GlobalRollbackResponseProto other = (GlobalRollbackResponseProto) obj;
  ...
  public static GlobalRollbackResponseProto parseFrom(
  ...
  public static GlobalRollbackResponseProto parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static GlobalRollbackResponseProto parseFrom(
  ...
  public static GlobalRollbackResponseProto parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static GlobalRollbackResponseProto parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static GlobalRollbackResponseProto parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(GlobalRollbackResponseProto prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using GlobalRollbackResponseProto.newBuilder()
    private Builder() {
    ...
    public GlobalRollbackResponseProto getDefaultInstanceForType() {
      return GlobalRollbackResponseProto.getDefaultInstance();
    }

    public GlobalRollbackResponseProto build() {
      GlobalRollbackResponseProto result = buildPartial();
    ...
    public GlobalRollbackResponseProto buildPartial() {
      GlobalRollbackResponseProto result = new GlobalRollbackResponseProto(this);
      if (abstractGlobalEndResponseBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof GlobalRollbackResponseProto) {
        return mergeFrom((GlobalRollbackResponseProto)other);
      } else {
    ...
    public Builder mergeFrom(GlobalRollbackResponseProto other) {
      if (other == GlobalRollbackResponseProto.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      GlobalRollbackResponseProto parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (GlobalRollbackResponseProto) e.getUnfinishedMessage();
  ...
  private static final GlobalRollbackResponseProto DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GlobalRollbackResponseProto();
  }
