 ...
 */
package com.jef.transaction.core.context;
...
import static com.jef.transaction.core.model.BranchType.AT;
import static com.jef.transaction.core.model.BranchType.XA;
...
public class RootContext {
    ...
    public static BranchType getBranchType() {
        if (inGlobalTransaction()) {
            ...
            return DEFAULT_BRANCH_TYPE != null ? DEFAULT_BRANCH_TYPE : AT;
        }
        return null;
    }
