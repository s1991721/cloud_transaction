 ...
 */
package com.jef.transaction.core.rpc.netty;
...
import com.jef.transaction.common.exception.FrameworkErrorCode;
...
import com.jef.transaction.core.protocol.transaction.AbstractGlobalEndRequest;
...
import com.jef.transaction.core.rpc.processor.Pair;
import com.jef.transaction.core.rpc.processor.RemotingProcessor;
import com.jef.transaction.discovery.loadbalance.LoadBalanceFactory;
import com.jef.transaction.discovery.registry.RegistryFactory;
...
import static com.jef.transaction.common.exception.FrameworkErrorCode.NoAvailableService;
