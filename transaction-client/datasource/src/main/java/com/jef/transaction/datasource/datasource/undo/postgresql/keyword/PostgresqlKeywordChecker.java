 ...
 */
package com.jef.transaction.datasource.datasource.undo.postgresql.keyword;
...
import com.jef.transaction.datasource.datasource.undo.KeywordChecker;
...
public class PostgresqlKeywordChecker implements KeywordChecker {
    ...
    private Set<String> keywordSet = Arrays.stream(PostgresqlKeyword.values())
            .map(PostgresqlKeyword::name).collect(Collectors.toSet());
